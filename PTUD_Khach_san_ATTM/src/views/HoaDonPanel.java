...
public class HoaDonPanel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HoaDonPanel frame = new HoaDonPanel();
	...
	public HoaDonPanel() {
		...
		contentPane.setBackground(new Color(236, 247, 255));
		...
		pnlBoLocHoaDon.setBounds(20, 64,1496 , 110);
		contentPane.add(pnlBoLocHoaDon);
		...
		lbl_Boloc.setBounds(20, 34, 62, 20);
		contentPane.add(lbl_Boloc);
		
		JLabel lbl_DanhSachHoaDon = new JLabel("Danh Sách Hóa Đơn");
		lbl_DanhSachHoaDon.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lbl_DanhSachHoaDon.setBounds(20, 184, 180, 20);
		contentPane.add(lbl_DanhSachHoaDon);
		...
		pnlDanhSachHoaDon.setBounds(20, 214, 780, 567);
		contentPane.add(pnlDanhSachHoaDon);
		...
		scrollPane.setBounds(10, 10, 760, 548);
		...
		lbl_ThongTinHoaDon.setBounds(838, 184, 180, 20);
		contentPane.add(lbl_ThongTinHoaDon);
		...
		pnlThongTinHoaDon.setBounds(838, 214, 678, 349);
		contentPane.add(pnlThongTinHoaDon);
		...
		contentPane.add(pnlChiTietHoaDon);
		...
		contentPane.add(lbl_ChiTietHoaDon);
	}
}
