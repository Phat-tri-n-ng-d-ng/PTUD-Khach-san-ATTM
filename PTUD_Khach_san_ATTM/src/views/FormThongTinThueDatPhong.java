...
public class FormThongTinThueDatPhong extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            FormThongTinThueDatPhong dialog = new FormThongTinThueDatPhong();
     ...
     * Create the dialog.
     */
    public FormThongTinThueDatPhong() {
        jbInit();
    }
    private void jbInit() {
        ...
        JLabel lblTieuDeForm = new JLabel("Thông tin đặt/ thuê phòng");
        ...
        JLabel lblFromThongTinKhachHang = new JLabel("Thông tin khách hàng thuê/đặt phòng");
