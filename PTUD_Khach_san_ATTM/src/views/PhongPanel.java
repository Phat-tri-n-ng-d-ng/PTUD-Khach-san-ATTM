...
public class PhongPanel extends JPanel {
	...
	public PhongPanel() {
		...
		lbl_TieuDe.setFont(new Font("Times New Roman", Font.BOLD, 32));
		lbl_TieuDe.setBounds(725, 10, 114, 32);
		add(lbl_TieuDe);
		...
		pnlThongTinPhong.setBounds(20, 64,1496 , 149);
		...
		btn_ThemPhong.setBounds(1321, 62, 120, 30);
		pnlThongTinPhong.add(btn_ThemPhong);
		
		JButton btn_CapNhat = new JButton("Cập nhật");
		btn_CapNhat.setBounds(1156, 62, 120, 30);
		...
		pnlBoLoc.setBounds(20, 265, 1496, 82);
		add(pnlBoLoc);
		...
		chckbx_FamilyRoom.setBounds(550, 40, 100, 22);
