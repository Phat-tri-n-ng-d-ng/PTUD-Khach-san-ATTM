...
public class LoaiPhongPanel extends JPanel {
	...
	private JTextField txt_TyLeCoc;
	private JTextField txt_GiaNiemYet;
	...
	public LoaiPhongPanel() {
		...
		lbl_TieuDe.setBounds(725, 10, 166, 32);
		add(lbl_TieuDe);
		...
		pnlThongTinLoaiPhong.setBounds(20, 64,1496 , 149);
		...
		lbl_ThongTinLoaiPhong.setBounds(20, 34, 197, 20);
		...
		lbl_DanhSachLoaiPhong.setBounds(20, 235, 180, 20);
		...
		pnlDanhSachLoaiPhong.setBounds(20, 270, 1496, 547);
		...
		scrollPane.setBounds(10, 10, 1476, 526);
